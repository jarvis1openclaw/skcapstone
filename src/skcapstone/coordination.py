"""Re-export shim: the multi-agent task board moved to skcoord (CR-4.1 extraction).

``skcapstone.coordination`` is now a transparent alias of ``skcoord.coordination`` (the same
...
import skcoord.coordination as _src
