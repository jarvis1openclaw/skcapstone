"""Re-export shim: dashboard_assistant moved to skdashboard (CR-4.3 dashboard split).

``skcapstone.dashboard_assistant`` is now a transparent alias of the skdashboard module
...
import skdashboard.dashboard_assistant as _src
