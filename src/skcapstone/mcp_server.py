    ...
    return [
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "importance": {
                        "type": "number",
                        "description": (
                            "Importance score 0.0-1.0 " "(>= 0.7 auto-promotes to mid-term)"
                        ),
                    },
                    "source": {
                        "type": "string",
            ...
            inputSchema={
                ...
                "properties": {
                    "action": {
                        ...
                        "enum": ["diff", "save"],
                        "description": (
                            "Action: diff (compare) or save (new baseline). " "Default: diff."
                        ),
                    },
                },
                "required": [],
            ...
            inputSchema={
                ...
                "properties": {
                    "action": {
                        ...
                        "description": (
                            "Action: show current, recommend changes, set a value, "
                            "or reset (default: show)"
                        ),
                    },
                    "key": {
                        "type": "string",
            ...
            inputSchema={
                ...
                "properties": {
                    "tool": {
                        "type": "string",
                        "description": (
                            "Fully-qualified tool name, " "e.g. 'syncthing-setup.check_status'"
                        ),
                    },
                    "args": {
                        "type": "object",
            ...
            inputSchema={
                ...
                "properties": {
                    "recipient": {
                        "type": "string",
                        "description": (
                            "Recipient agent name or CapAuth URI "
                            "(e.g. 'lumina' or 'capauth:lumina@skworld.io')"
                        ),
                    },
                    "message": {
                        "type": "string",
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "members": {
                        ...
                        "items": {"type": "string"},
                        "description": (
                            "Initial member URIs to add " "(creator is always included as admin)"
                        ),
                    },
                },
                "required": ["name"],
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "auto_rotate": {
                        "type": "boolean",
                        "description": (
                            "Enable auto-rotate after repeated failures " "(default: true)"
                        ),
                    },
                },
                "required": [],
            ...
            inputSchema={
                ...
                "properties": {
                    "status": {
                        "type": "string",
                        "description": (
                            "Agent status: alive, busy, draining, offline " "(default: alive)"
                        ),
                    },
                    "claimed_tasks": {
                        "type": "array",
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "mode": {
                        "type": "string",
                        "description": (
                            "Brainstorming mode: socratic, dialectic, "
                            "adversarial, collaborative (default: dialectic)"
                        ),
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "mode": {
                        "type": "string",
                        "description": (
                            "Import mode: 'daily' (consolidate per day) "
                            "or 'message' (one per message)"
                        ),
                        "enum": ["daily", "message"],
                        "default": "daily",
                    },
            ...
            inputSchema={
                ...
                "properties": {
                    "chat": {
                        "type": "string",
                        "description": (
                            "Chat username, title, or numeric ID " "to announce the swap in"
                        ),
                    },
                    "from_soul": {
                        "type": "string",
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "privacy_sensitive": {
                        "type": "boolean",
                        "description": (
                            "Force LOCAL tier — data never leaves node " "(default: false)"
                        ),
                    },
                    "estimated_tokens": {
                        "type": "integer",
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "tailnet_hostname": {
                        "type": "string",
                        "description": (
                            "Tailscale hostname for Tier 2 document " "(auto-detected if omitted)"
                        ),
                    },
                    "tailnet_name": {
                        "type": "string",
        ...
        Tool(
            ...
            description=(
                ...
                "Set publish_public=false to opt out — identity stays private "
                "(did:key + mesh only). "
            ...
            inputSchema={
                ...
                "properties": {
                    "publish_public": {
                        "type": "boolean",
                        "description": (
                            "Set to false to opt out of public Tier 3 DID. "
                            "Omit to view current policy."
                        ),
                    },
                },
                "required": [],
        ...
        Tool(
            ...
            description=(
                "Show Agent Reach internet capability status and active "
                "backends for web, search, video, GitHub, RSS, and optional "
        ...
        Tool(
            ...
            description=(
                "Search the public web through SKCapstone's Agent Reach "
                "facade. Uses the configured Exa/mcporter route and can "
                "optionally store the fetched result in SKMemory."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "timeout": {
                        "type": "integer",
                        "description": "Command timeout in seconds (default: 45)",
                    },
                    "store": {
                        "type": "boolean",
                        "description": "Store the fetched output in SKMemory",
                    },
                    "tags": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Additional memory tags when store=true",
                    },
                    "importance": {
                        "type": "number",
                        "description": "Memory importance when store=true (default: 0.55)",
                    },
                },
                "required": ["query"],
            },
        ...
        Tool(
            name="internet_read",
            description=(
                "Read a public HTTP(S) URL through SKCapstone's Agent Reach "
                "facade. Uses Jina Reader first and falls back to direct HTTP "
                "when the reader is blocked. Can optionally store the fetched "
                "result in SKMemory."
            ),
            inputSchema={
                "type": "object",
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    handlers = {
        ...
        "internet_doctor": _handle_internet_doctor,
        "internet_search": _handle_internet_search,
        "internet_read": _handle_internet_read,
        # Brain-First Protocol
...
# ── Internet capability handlers ─────────────────────────


async def _handle_internet_doctor(args: dict) -> list[TextContent]:
    """Return Agent Reach channel status."""
    from .internet import InternetError, doctor

    try:
        return _json_response(doctor(timeout=args.get("timeout", 30)))
    except InternetError as exc:
        return _error_response(str(exc))


async def _handle_internet_search(args: dict) -> list[TextContent]:
    """Search the web through the Agent Reach facade."""
    ...
    try:
        ...
        if args.get("store"):
            entry = store_result(
                ...
                result,
                tags=args.get("tags", []),
                importance=args.get("importance", 0.55),
            )
...
async def _handle_internet_read(args: dict) -> list[TextContent]:
    """Read a public URL through the Agent Reach facade."""
