...
| OM-2 | Temporal service restart | `docker restart` of the temporal container | client queries fail while the frontend is down; workflow phase unchanged | workflow still queryable, phase preserved, completes after restart with one receipt |
